...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        aria-hidden
        className="animate-ambient pointer-events-none absolute inset-0 -z-10 opacity-40 blur-3xl"
        style={{
          background:
            'radial-gradient(60% 60% at 30% 30%, rgba(16,185,129,0.35), transparent 70%), radial-gradient(50% 50% at 70% 60%, rgba(59,130,246,0.35), transparent 70%)',
        }}
      />
